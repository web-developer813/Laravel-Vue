<div class="site-menubar">
		...
		<div>
			<div>
				<ul class="site-menu" data-plugin="menu">
					...
					<li class="site-menu-item {{ nav_active('forprofits.dashboard') }}">
						<a class="animsition-link" href="{{ route('forprofits.dashboard', $authForprofit->id) }}">
					...
					<li class="site-menu-item">
						<a class="animsition-link" href="javascript:void(0)">
							...
							<span class="site-menu-title">Offers</span> <div class="site-menu-label"><span class="badge badge-sm badge-primary">Coming Soon</span></div>
						</a>
					</li>
					<li class="site-menu-item {{ nav_active('forprofits.incentives.index') }} {{ nav_active('incentives.show') }}">
						<a class="animsition-link" href="{{ route('forprofits.incentives.index', $authForprofit->id) }}">
					...
					<li class="site-menu-item {{ nav_active('forprofits.settings.profile') }}">
						<a class="animsition-link" href="{{ route('forprofits.settings.profile', $authForprofit->id) }}">
	...
	<div class="site-menubar-footer">
		<a href="{{ route('forprofits.settings.profile', $authForprofit->id) }}" class="fold-show" data-placement="top" data-toggle="tooltip" data-original-title="Settings">
