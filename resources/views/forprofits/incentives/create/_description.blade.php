...
<section>
	@include('app.components.form-field', [
		...
		'input' => Form::text('title', old('title'), ['class' => 'form__field form-control', 'v-model' => 'fields.title'])
	])
	@include('app.components.form-field', [
		'field' => 'description', 'label' => 'Description', 'v_model' => 'description',
		'input' => Form::textarea('description', old('description'), ['class' => 'form__field form-control', 'rows' => 3, 'v-model' => 'fields.description'])
	])
	@include('app.components.form-field', [
		'field' => 'summary', 'label' => 'Offer Summary', 'v_model' => 'summary',
		'input' => Form::textarea('summary', old('summary'), ['class' => 'form__field form-control', 'rows' => 3, 'maxlength' => 300, 'v-model' => 'fields.summary'])
	])
	<div class="form-field" v-bind:class="{ 'has-error': errors.photo }">
		<label class="form__label form-control-label">Photo</label>
...
<section style="margin-bottom: 40px;">
	...
	@include('app.components.form-field', [
		...
		'input' => Form::number('price', old('price'), ['class' => 'form__field form-control', 'v-model' => 'fields.price'])
	])
	{{--@include('app.components.checkbox-toggle', [--}}
		{{--'field' => 'employee_specific', 'label' => 'Employee Specific', 'value' => true, 'v_model' => 'fields.employee_specific'--}}
	{{--])--}}
...
<section>
	<div class="form-field" v-bind:class="{ 'has-error': errors.barcode }">
		...
		<div class="field-wrapper">
			<div class="image-upload js-image-uploader" data-name="barcode" style=""></div>
