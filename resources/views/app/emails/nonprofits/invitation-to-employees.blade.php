...
@section('content')
	...
	@include('app.components.emails.p', [
		'content' => "You have been invited to join the <em>{$nonprofit->name}</em> team on Tecdonor."
	])
	@include('app.components.emails.p', [
	...
	@include('app.components.emails.p', [
		'content' => "Also, as a member of the {$nonprofit->name} team, your account is completely free! Please click the button below to get started."
	])
