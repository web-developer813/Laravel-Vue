...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="//d3dhju7igb20wy.cloudfront.net/assets/0-4-0/all-the-things.css" />
...
<section class="blue-gradient-background splash">
    <div class="container center-all-container">
        <form id="notify_form" action="/api/notifications/" method="post">
...
function notifySubmit() {
  ...
  $.post('/api/notifications', data).success(notifySuccess);
...
function showNotification(data) {
  toastr.success(data.text, null, {"positionClass": "toast-top-right"});
}
</script>
