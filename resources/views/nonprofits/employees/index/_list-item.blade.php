<li class="list-item">
	...
	<div class="column column--25">
		<a :href="item.volunteer.url" class="btn btn--default btn--small btn--block" v-if="item.role.name == 'nonprofit_owner'">View Profile</a>
		<div class="btn-group" v-if="item.role.name != 'nonprofit_owner'">
