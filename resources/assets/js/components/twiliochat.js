...
var twiliochat = (function() {
  ...
  var notifyTyping =  _.debounce(function(event) {
  ...
  //   $.post('/api/token/', {identity: username, device: 'browser'}, null, 'json')
  ...
  function connectMessagingClient(token) {
    ...
    tc.messagingClient.initialize()
      .then(function() {
        ...
        //tc.messagingClient.on('channelAdded', _.debounce(tc.loadChannelList));
        //tc.messagingClient.on('channelRemoved', _.debounce(tc.loadChannelList));
